						...
						/*	$(".classf").prop("readonly", true);
							...
							*/
							...
							while(month == thursday.month()){
							    //document.body.innerHTML += "<p>"+thursday.toString()+"</p>";
							    
							    thursday = thursday.weekday(11);
							}*/
							var lastthursdayForMonth = function (monthMoment) {
							  var lastDay = monthMoment.endOf('month').startOf('day');
							  switch (lastDay.day()) {
							    case 5:
							      return lastDay.subtract(0, 'days');
							    default:
							      return lastDay.subtract(lastDay.day() + 3, 'days');
							  }
							}
							var today=d.getFullYear() + '/' +(month<10 ? '0' : '') + month + '/' +(day<10 ? '0' : '') + day;
							console.log(today);
							var thursday=lastthursdayForMonth(moment('2016-07-14'));
							var short=thursday.toString();
							thursday = jQuery.trim(short).substring(0, 16).split(" ").slice(0, -1).join(" ");
							if(name=="")
							{
							...
							{
							$(this).parent().parent().find("td:nth-child(3) input").val(thursday.toString());
							}
							var $th = $(this);
...
function showentry(){
	...
	{	
		...
		var month = d.getMonth()+1;
		var day = d.getDate();
		var date1="closing at "+d.getFullYear() + '/' +(month<10 ? '0' : '') + month + '/' +(day<10 ? '0' : '') + day;	 	
